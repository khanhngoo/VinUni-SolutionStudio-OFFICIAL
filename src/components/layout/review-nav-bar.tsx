...
/**
 * One generic internal-unit review runtime header — deliberately not
 * "CAID" or "E-Lab" branded. The same code serves any real INTERNAL_UNIT
 * actor; their own organization membership scopes what they can see, not
 * the route or the header.
 */
export function ReviewNavBar({ identity }: { identity: AuthenticatedPresentation | null }) {
  return (
